...
from src import CombineRawDatasets, TranslateRapidProKeys, AutoCode, ProductionFile, \
    ApplyManualCodes, AnalysisFile, WSCorrection, ListeningGroup
...
if __name__ == "__main__":
    ...
    parser.add_argument("listening_groups_dir_path", metavar="listening-groups-dir-path",
                        help="Directory containing de-identified listening groups contacts CSVs.")
    ...
    listening_groups_dir_path = args.listening_groups_dir_path
    ...
    ListeningGroup.tag_listening_groups_participants(user, data, listening_groups_dir_path)
